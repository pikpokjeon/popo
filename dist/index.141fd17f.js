...
${frame.code}`;
    ...
    "8lqZg": [
        function(require, module1, exports1) {
            ...
            const moveTo = (target, store)=>(y, x)=>{
                    // const {layer}
                    const [ay, ax] = store.get("coord");
                    console.log(ay, ax);
            ...
            const keyInput = (store)=>(e)=>{
                    ...
                    const circle = (0, _utilsJs.el).id("user");
                    const move = moveTo(circle, store);
                    const [y, x] = store.get("coord");
            ...
            const store = ({ data , ...subs })=>{
                ...
                const set = ({ data , ...subs })=>{
                    ...
                    Reflect.set(storage, k, data[k]);
                };
                const get = (k)=>Object.assign({}, storage)[k];
                set({
                    data,
                    ...subs
                });
            ...
            document.addEventListener("keydown", keyInput(state));
    ...
    "en4he": [
        function(require, module1, exports1) {
            ...
            parcelHelpers.export(exports1, "pipe", ()=>pipe);
            parcelHelpers.export(exports1, "el", ()=>el);
            parcelHelpers.export(exports1, "is", ()=>is);
            parcelHelpers.export(exports1, "isChildren", ()=>isChildren);
            parcelHelpers.export(exports1, "setObj", ()=>setObj);
            parcelHelpers.export(exports1, "renderTo", ()=>renderTo);
            var _libJs = require("./lib.js");
    ...
    "3bBc4": [
        function(require, module1, exports1) {
            var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
            parcelHelpers.defineInteropFlag(exports1);
            parcelHelpers.export(exports1, "setAttr", ()=>setAttr);
            parcelHelpers.export(exports1, "removeChildren", ()=>removeChildren);
            parcelHelpers.export(exports1, "updateChildren", ()=>updateChildren1);
            parcelHelpers.export(exports1, "createElement", ()=>createElement);
            parcelHelpers.export(exports1, "element", ()=>element);
            parcelHelpers.export(exports1, "fragment", ()=>fragment);
            var _utilsJs = require("./utils.js");
            const setAttr = (type, el, attr)=>{
                const attributes = Object.entries(attr);
                if ((0, _utilsJs.is)["array"](attributes)) return attributes.reduce((acc, [key, val])=>{
            ...
            const updateChildren1 = (type, parent, children = [])=>{
                if ((0, _utilsJs.is)["undefined"](children)) return parent;
                if (!(0, _utilsJs.is)["array"](children)) children = [
                    children
                ];
            ...
            const createElement = (type)=>(tag, attr = {}, children = [])=>{
                    ...
                    if ((0, _utilsJs.isChildren)(attr)) {
                        updateChildren1(type, el, children);
                        return el;
                    }
    ...
    "ShInH",
    "8lqZg"
], "8lqZg", "parcelRequireffc5");

//# sourceMappingURL=index.141fd17f.js.map
